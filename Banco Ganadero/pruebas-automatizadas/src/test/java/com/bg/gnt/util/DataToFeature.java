	 ...
	 //public void overrideFeatureFiles(String featuresDirectoryPath)
	        ...
	        for (File featureFile : listOfFeatureFiles) {
	            ...
	            try (BufferedWriter writer = new BufferedWriter(
	            		//new OutputStreamWriter(new FileOutputStream(featureFile), System.setProperty("file.encoding", someEncoding)));) {
	                    new OutputStreamWriter(new FileOutputStream(featureFile), "UTF8"));) {
