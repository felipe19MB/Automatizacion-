...
import static bo.com.bga.certificacion.gananet.utils.GeneralConstants.TRANSFERENCIAS_TERCEROS_COMPROBANTE;
import static net.serenitybdd.screenplay.matchers.WebElementStateMatchers.*;

public class TransferirCuentasTerceros implements Task {
    ...
    public TransferirCuentasTerceros(TransferenciasModel transferenciasModel, String cuentaOrigen, String cuentaDestino, String monto, String tipoImporte, String scenario) {
    ...
    public static TransferirCuentasTerceros EntreCuentas(TransferenciasModel transferenciasModel, String cuentaOrigen, String cuentaDestino, String monto, String tipoImporte, String scenario) {
        return Tasks.instrumented(TransferirCuentasTerceros.class, transferenciasModel,cuentaOrigen,cuentaDestino,monto,tipoImporte, scenario);
    }
    ...
    public <T extends Actor> void performAs(T actor) {
        ...
        switch (scenario){
            case ("HappyPath"):
                ...
                OnStage.theActorInTheSpotlight().remember("MENSAJE COMPROBANTE", TRANSFERENCIAS_TERCEROS_COMPROBANTE);
                break;
        }
    }
}
