...
public class LlenarHistoricoCuentasTerceros implements Task {
    DatosHistoricos datosHistoricos;
    String scenario;

    public LlenarHistoricoCuentasTerceros(String scenario,DatosHistoricos datosHistoricos) {
        ...
        switch (scenario) {
            case ("HappyPath"):
                actor.attemptsTo(
                        ...
                        byVisibleText(datosHistoricos.getCuentaTercero()).from(TXT_CUENTAS_TERCEROS),
                        ...
                        JavaScriptClick.on(BOTON_GENERAR_HISTORICO_TERCEROS),
                        WaitUntil.the(HistoricoPagoPlanillas.CIRCULO_CARGA, isNotVisible()).forNoMoreThan(60).seconds()
                );
                break;
        }
    ...
    public static LlenarHistoricoCuentasTerceros go(String scenario, DatosHistoricos datosHistoricos){
        return Tasks.instrumented(LlenarHistoricoCuentasTerceros.class,scenario,datosHistoricos);
