package bo.com.bga.certificacion.gananet.utils.database;

import bo.com.bga.certificacion.gananet.utils.GeneralConstants;
import bo.com.bga.certificacion.gananet.utils.PropertiesReader;
import oracle.jdbc.internal.OracleTypes;

import java.sql.*;
import java.util.*;

public class GanaNetDao {

    private ConexionDAO conexion;
    private String username;
    private String password;
    public GanaNetDao(String schema) throws SQLException {
