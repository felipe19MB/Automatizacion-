package bo.com.bga.certificacion.api.utils.database;


import bo.com.bga.certificacion.api.utils.PropertiesReader;
import java.sql.*;
import java.util.*;
...
public class ApiDAO {
    ...
    public ApiDAO(String schema) throws SQLException {
