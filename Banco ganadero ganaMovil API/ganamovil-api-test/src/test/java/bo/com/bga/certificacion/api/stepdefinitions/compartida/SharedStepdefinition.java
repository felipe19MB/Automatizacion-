...
public class SharedStepdefinition {
    ...
    @Given("Que {string} inicio sesión en GanaMóvil Api")
    public void queInicioSesiónEnGanaMóvilApi(String actor, DataTable dataTable) {
        Map<String, Object> valoresUpdate = new HashMap<>();
        Map<String, Object> condicionesUpdate = new HashMap<>();
        Map<String, Object> condiciones = new HashMap<>();
        valoresUpdate.put("ESTADO", "A");
        condicionesUpdate.put("ESTADO", "P");
        ...
        theActorInTheSpotlight().remember("pStrNombreUsuario",filas.get(0).get("pStrNombreUsuario") );
        theActorCalled(actor).wasAbleTo(
                ...
                EjecutarBaseDeDatos.Actualizar("CAS_USUARIOXCANAL",condicionesUpdate,valoresUpdate,"GANADERO"),
