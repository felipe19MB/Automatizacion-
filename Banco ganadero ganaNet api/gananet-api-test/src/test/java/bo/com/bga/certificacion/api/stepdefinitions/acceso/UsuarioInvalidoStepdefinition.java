...
public class UsuarioInvalidoStepdefinition {
    ...
    public void llamaAlMetodoObtenerSesion(DataTable dataTable) {
        theActorInTheSpotlight().attemptsTo(
                EjecutarAcceso.obtenerSesion(ValidarClaveModel.setData(dataTable))
        );
    }
    ...
    public void deberiaVerLaRespuestaDelEndpoint(String mensaje) {
        theActorInTheSpotlight().should(seeThat(
                DEBERÍA_VALIDAR_EL_MENSAJE_EN_LA_RESPUESTA, ValidarMensajeRespuesta.expected(mensaje, theActorInTheSpotlight().recall("mensajeUsuarioIncorrecto"))
        ));
    }
}
